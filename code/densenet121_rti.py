...
# 경로 설정
train_path = '../../../data/islabdata/rti/train'
test_path ='../../../data/islabdata/rti/test'
...
#Train report 출력
print('Classification Report (DenseNet121 - Training - RTI):')
...
ax.set_title('Confusion Matrix - Training - RTI')
...
fig = ax.get_figure()
fig.savefig("DenseNet121_train_rti.png")
...
ax.set_title('Confusion Matrix - Test - RTI')
...
ax.yaxis.set_ticklabels(['fake', 'real'])
fig = ax.get_figure()
fig.savefig("DenseNet121_test_rti.png")